...
// In cloud mode a per-request context holds the logged-in user's state (loaded
// from / flushed to Postgres by middleware). Outside it, fall back to the file
// backend — keeps local dev and the whole test suite unchanged.
function get() {
